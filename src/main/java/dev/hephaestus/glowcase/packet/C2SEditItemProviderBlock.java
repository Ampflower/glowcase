...
public record C2SEditItemProviderBlock(BlockPos pos, AbstractItemDisplayBlockEntity.RotationType rotationType, ItemProviderBlockEntity.GivesItem givesItem, AbstractItemDisplayBlockEntity.Offset offset, C2SEditItemProviderBlock.ItemDisplayBlockValues values) implements C2SEditBlockEntity {
	...
	public static final PacketCodec<RegistryByteBuf, C2SEditItemProviderBlock> PACKET_CODEC = PacketCodec.tuple(
		...
		C2SEditItemProviderBlock.ItemDisplayBlockValues.PACKET_CODEC, C2SEditItemProviderBlock::values,
		C2SEditItemProviderBlock::new
	);

	public static C2SEditItemProviderBlock of(ItemProviderBlockEntity be) {
		return new C2SEditItemProviderBlock(be.getPos(), be.rotationType, be.givesItem, be.offset, new C2SEditItemProviderBlock.ItemDisplayBlockValues(be.getCachedState().get(Properties.ROTATION), be.showName, be.pitch, be.yaw));
	}
	...
	public record ItemDisplayBlockValues(int rotation, boolean showName, float pitch, float yaw) {
		public static final PacketCodec<RegistryByteBuf, C2SEditItemProviderBlock.ItemDisplayBlockValues> PACKET_CODEC = PacketCodec.tuple(
			PacketCodecs.INTEGER, C2SEditItemProviderBlock.ItemDisplayBlockValues::rotation,
			PacketCodecs.BOOL, C2SEditItemProviderBlock.ItemDisplayBlockValues::showName,
			PacketCodecs.FLOAT, C2SEditItemProviderBlock.ItemDisplayBlockValues::pitch,
			PacketCodecs.FLOAT, C2SEditItemProviderBlock.ItemDisplayBlockValues::yaw,
			C2SEditItemProviderBlock.ItemDisplayBlockValues::new
		);
	}
}
