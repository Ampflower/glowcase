...
public record C2SEditRecipeBlock(BlockPos pos, String recipe, TextBlockEntity.ZOffset offset) implements C2SEditBlockEntity {
	...
	public static C2SEditRecipeBlock of(RecipeBlockEntity be) {
		return new C2SEditRecipeBlock(be.getPos(), be.recipe, be.zOffset);
	}
